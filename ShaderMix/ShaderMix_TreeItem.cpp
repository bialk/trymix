...
ShaderMix_TreeItem::ShaderMix_TreeItem()
...
void
ShaderMix_TreeItem::showModel(DrawCntx* cx)
{
  glClearDepth(1.0);
...
void
ShaderMix_TreeItem::activateProjectTreeItem(QDockWidget* dock, bool activate){
