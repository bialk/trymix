...
MRFSegm_TreeItem::MRFSegm_TreeItem()
...
{  
  ...
  MRFSegm_Test(m_panel.spinBox_width->value(), m_panel.spinBox_height->value(),
  ...
  QObject::connect(m_panel.pushButton_runBlurCPU, &QPushButton::clicked,
    m_panel.pushButton_runBlurCPU, [&]{
       ...
       auto msec = MRFSegm_Test(m_panel.spinBox_width->value(), m_panel.spinBox_height->value(),
                m_panel.spinBox_radius->value(), m_panel.spinBox_chessBox->value(), m_img, false);
...
void
MRFSegm_TreeItem::activateProjectTreeItem(QDockWidget* dock, bool activate){
...
void
MRFSegm_TreeItem::showModel(DrawCntx* cx){
